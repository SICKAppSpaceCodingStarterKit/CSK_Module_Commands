...
export function addParameterNoInfo1(value) {
  var paramNum = "1"
  return [paramNum, value.toString()]
}

export function addParameterNoInfo2(value) {
  var paramNum = "2"
  return [paramNum, value.toString()]
}

export function addParameterNoInfo3(value) {
  var paramNum = "3"
  return [paramNum, value.toString()]
}

export function addParameterNoInfo4(value) {
  var paramNum = "4"
  return [paramNum, value.toString()]
}
...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_Commands .myCustomBackground_CSK_Module_Commands { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_Commands .myCustomBackground_CSK_Module_Commands { background-color: #fff; }` // font-family: "sans-serif"; }`
